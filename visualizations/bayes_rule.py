...
def run_simulation_on_parameters(parameter_sets):
    ...
    for p_cancer_initial, accuracy_range, false_positive_range, _ in parameter_sets:
        p_cancer_values, parameters = simulate_diagnosis(
            p_cancer_initial, accuracy_range, false_positive_range
        )
...
if __name__ == "__main__":
    ...
    parameter_sets = [
        ...
        (
            ...
            (0.5, 0.5),
            (0.01, 0.5),
            "high initial self-doubt + high accuracy/false-positive rate variance",
        ),
